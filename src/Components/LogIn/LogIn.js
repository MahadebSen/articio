...
const LogIn = () => {
  ...
  return (
    <section className="text-gray-600 body-font relative max-w-5xl mx-auto">
      <div className="container px-5 py-10 md:py-20 mx-auto flex sm:flex-nowrap flex-wrap">
        <form
          onSubmit={handleLogin}
          className="md:w-1/2 lg:w-1/2 mx-auto  bg-white flex flex-col md:ml-auto w-full p-8 mt-8 md:mt-0 rounded-lg"
        >
          <h2 className="text-gray-900 text-3xl pb-5 font-medium title-font">
            Log In
          </h2>
          ...
          <p className="text-xs text-gray-500 mt-4">Or, you may choose,</p>
